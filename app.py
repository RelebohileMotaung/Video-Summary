...
if st.session_state.active_tab == "summarize":
    ...
    if input_method == "YouTube URL":
        ...
        st.info("📁 **File Upload Guidelines:**\n"
                "- Maximum file size: ~50MB (for audio processing)\n" 
                "- Supported formats: MP4, AVI, MOV, MKV\n"
                "- For best results, use videos under 10 minutes")
    ...
    default_language = st.selectbox(
        ...
        ["english", "spanish", "french", "german", "chinese", "japanese", "arabic", "sesotho", "zulu", "tsonga", "setswana","xhosa","sepedi"],
        index=0
    )
